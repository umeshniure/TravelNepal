                        ...
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="card mt-5" style="border-radius: 15px;">
                                <div class="card-body p-5">
                                    <h2 class="text-uppercase text-center mb-5">Register as a vendor</h2>
                                    ...
                                    <form method="POST" action="vendorRegistration">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <label class="form-label" for="form3Example1cg">Agency Name</label>
                                        </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <label class="form-label" for="form3Example3cg">Tel/phone Number</label>
                                        </div>
                                        
                                        <div class="form-outline mb-4">
                                            <input type="text" name="address" id="form3Example3cg" class="form-control form-control-lg" required/>
                                            <label class="form-label" for="form3Example3cg">Address</label>
                                        </div>
                                        
                                        <div class="form-outline mb-4">
                                            <input type="number" name="pan" id="form3Example3cg" class="form-control form-control-lg" required/>
                                            <label class="form-label" for="form3Example3cg">PAN Number</label>
                                        </div>
